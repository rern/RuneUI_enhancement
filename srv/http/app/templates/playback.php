        ...
        <div id="container-playback">
            ...
            <div class="row" id="playback-row">
                <div id="time-knob">
                    ...
                    <button id="overlay-playsource-open" title="View and change playback source" style="margin-top: -330px;" class="btn btn-default btn-xs<?php if ($this->spotify === '0') echo " disabled"?>">MPD</button>
