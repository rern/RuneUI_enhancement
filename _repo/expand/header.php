...
<div id="menu-top">
    <div class="dropdown">
        <button id="menu-settings" class="btn-default dropdown-toggle" role="button" data-toggle="dropdown" data-target="#" href="#"><i class="fa fa-gear"></i></button>
...
<?php
if (!exec("/usr/bin/sudo /usr/bin/sfdisk -F | grep 'mmcblk0' | awk '{print $6}'")) {
?>
            <li><a href="#expand-modal" data-toggle="modal"><i class="fa fa-arrows-h"></i> root partition</a></li>
<?php
}
?>
...
<?php /*    <a class="home" href="/"><img src="<?=$this->asset('/img/logo.png')?>" class="logo" alt="RuneAudio"></a>*/?>
    <button id="gpio" class="btn btn-default btn-cmd"><i class="fa fa-volume-off fa-lg"></i></button>
</div>
<div id="menu-bottom">
    <ul>
        <li id="open-panel-sx"><a href="/#panel-sx"<?=$this->uri(1, '', ' class="open-panel-sx" data-toggle="tab"')?>><i class="fa fa-folder-open"></i></a></li>
        <li id="open-playback"<?=$this->uri(1, '', ' class="active"')?>><a href="/#playback"<?=$this->uri(1, '', ' data-toggle="tab"')?>><i class="fa fa-play-circle"></i></a></li>
