...
```sh
wget -qN --show-progress --no-check-certificate https://github.com/rern/RuneUI_enhancement/raw/master/_repo/lato.tar.xz; bsdtar -xvf lato.tar.xz -C /srv/http/assets/fonts/lato
```
