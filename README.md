...
```sh
wget -q --show-progress -O lato.tar.xz "https://github.com/rern/RuneUI_enhancement/blob/master/_repo/lato.tar.xz?raw=1"
tar -Jxvf lato.tar.xz -C /srv/http/assets/fonts/lato
```
